...
def test_unbalanced_tree_instantiates(unbalanced_tree):
    ...
    assert utree.root_node.left_child.value == 4
    assert utree.root_node.left_child.left_child.value == 2
    assert utree.root_node.right_child.value == 16
    assert utree.root_node.right_child.left_child.value == 10
    assert utree.root_node.right_child.right_child.value == 26
    assert utree.root_node.right_child.right_child.right_child.value == 42
...
def test_bst_instantiates(balanced_tree):
    ...
    assert bst.root_node.left_child.value == 3
    assert bst.root_node.left_child.left_child.value == 1
    assert bst.root_node.left_child.right_child.value == 5
    assert bst.root_node.right_child.value == 11
    assert bst.root_node.right_child.left_child.value == 9
